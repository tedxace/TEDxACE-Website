...
const Button = ({ text, link, className }) => {
  return (
    <Link to={link ? link : "#"}>
      <button
        className={cn(
          "button group relative flex items-center justify-center overflow-hidden text-center transform skew-x-0 w-[105px] h-[20px] md:w-[144px] md:h-[50px] border-tedx-heading bg-tedx-bg border border-spacing-3 border-collapse mt-2 mb-2 py-2 px-3 rounded-md font-['Inter'] ",
          className
        )}
      >

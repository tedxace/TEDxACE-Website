            ...
            <div className="flex  md:flex-row flex-col justify-between items-center w-full ">
                <div className="flex flex-col  items-center gap-4  w-1/2 ">
                    <div className="flex flex-col justify-center items-center gap-10">
                        ...
                        <div className="md:hidden bottom-10 right-0 md:-mr-30 bg-[#111] mb-5  text-white px-10 py-5 w-[200px]  md:w-[300px] h-auto flex text-xl flex-col rounded-xl gap-2">
                                <h1 className="text-gray-300 font-bold text-lg">Venue: </h1>
                                <p className="capitalize">Phase Three ground floor lobby</p>
                            </div>
                    </div>
                ...
                <div className="w-1/2 flex justify-center items-center ">
                    <div className="flex flex-col-reverse items-center gap-4  md:w-1/2">
                        ...
                        <div className="w-[200px]  h-[300px] md:w-[400px] md:h-[600px]  rounded-2xl bg-[url('./venue2.png')] bg-cover bg-center relative">
                            <div className="sm:absolute bottom-10 right-0 md:-mr-30 bg-[#111]  text-white px-10 py-5 md:w-[300px] h-auto md:flex hidden text-xl flex-col rounded-xl gap-2">
                                <h1 className="text-gray-300 font-bold text-lg">Venue: </h1>
                                <p className="capitalize">Seminar Hall Phase Three 4th floor</p>
                            </div>
                        </div>
                        <div className="md:hidden bottom-10 right-0 md:-mr-30 bg-[#111]  text-white px-10 py-5 md:w-[300px] h-auto flex text-xl flex-col rounded-xl gap-2">
                                <h1 className="text-gray-300 font-bold text-lg">Venue: </h1>
                                <p className="capitalize">Seminar Hall Phase Three 4th floor</p>
                            </div>
                    </div>

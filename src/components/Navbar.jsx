...
const Navbar = () => {
  return (
    ...
    >
      ...
      <ul>
        <li>
          <button className="border-r-2 transition-all border-l-2 border-b-0 border-tedx-white px-4 py-2 rounded-lg duration-200 shadow-tedx-white hover:shadow-lg bg-gradient-to-r bg-200% from-tedx-blue/40 to-tedx-pink/40 bg-left hover:bg-right">
            Join Now
          </button>
        </li>
      </ul>
